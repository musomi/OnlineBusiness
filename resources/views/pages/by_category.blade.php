                                    ...
                                    <div class="col-12">
                                        <div class="card m-b-20">
                                            <div class="card-body">
                                                ...
                                                <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td><a href="/CategoryProducts/edit/{{$product->product_id}}"><?= $product['product_name']; ?></a></td>
                                                       <td><?= $product['price']; ?></td>
                                           ...
                                           <!-- sample modal content -->
								                  ...
								                  <form action="/CategoryProduct/store" method="POST" enctype="multipart/form-data">

                                    {{csrf_field()}}
                                    <input type="hidden" name="category_id" class="form-control" value="{{$food->category_id}}"/>
