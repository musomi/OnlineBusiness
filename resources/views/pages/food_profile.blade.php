...
<div class="page-content-wrapper">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
								...
								<form action="/CategoryProducts/update/{{$service->product_id}}" method="POST">
                  {{csrf_field()}}
                  ...
                  ?>
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <select name="category_id" class="form-control select2">
														                            <option value="<?=$service['category_id']?>">Select</option>
                                                            <optgroup label="Select to Change Product Category">
															                              <?php

                                                             foreach($foods as $food): ?>
                                                              @if(count(Sub_categorie::where('category_id',$food['category_id'])->get()) == 0)
