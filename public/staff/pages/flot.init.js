...
!function($) {
    ...
    FlotChart.prototype.createDonutGraph = function(selector, labels, datas, colors) {
        ...
        FlotChart.prototype.init = function() {
          //plot graph data
          var desktops = [[0, 50], [1, 180], [2, 80], [3, 70], [4, 180], [5, 105], [6, 250]];
          var laptops = [[0, 80], [1, 100], [2,60], [3, 120], [4, 140], [5, 100], [6, 105]];
          var tablets = [[0, 40], [1, 80], [2, 70], [3, 140], [4, 250], [5, 80], [6, 200]];
          var plabels = ["Desktops","Laptops","Tablets"];
          var pcolors = ['#6362b8', '#2bd3ac','#eb7475'];
          ...
          var datas = [20,30, 15];
          var colors = ['#6362b8', '#2bd3ac','#eb7475'];
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


            //real time data representation
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#2bd3ac']);
            plot.draw();
            var $this = this;
            function updatePlot() {
          ...
          var donutcolors = ['#6362b8', '#2bd3ac','#eb7475'];
